package com.websystique.max.configuration;
...
@ComponentScan({"com.websystique.max.configuration"})
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[]{"com.websystique.max.model"});
